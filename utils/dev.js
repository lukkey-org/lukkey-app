...
export default React.memo(function FloatingWindow() {
  ...
  const openFastTradeTest = () => {
    try {
      ...
      navigation.navigate("FastCryptoTradeTest");
    } catch (error) {
      setAddress("Failed to open Crypto Quick Trade Test");
      console.warn("Failed to open Crypto Quick Trade Test", error);
    }
  };
        ...
        <View {...panelPanResponder.panHandlers}>
          ...
          >
            <MaterialCommunityIcons
              ...
              color="#FFFFFF"
            />
            <Text style={styles.quickTradeButtonText}>
              Crypto Quick Trade Test
            </Text>
          </TouchableOpacity>
