...
const CHAIN_ICON_MAP = {
  ...
  // okb: CRYPTO_ICON_MAP.OKT, // OKB is no longer supported.
...
export function resolveAssetIcon(asset) {
  return resolveAssetIconByValue({
    shortName: getAssetSymbol(asset),
    name: getAssetDisplayName(asset),
    queryChainName: getAssetChainFullName(asset),
    queryChainShortName: getAssetChainShortName(asset),
  });
}
