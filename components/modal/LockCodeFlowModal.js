...
const LockCodeFlowModal = ({
  ...
  const dismissKeyboardAndRun = useCallback((action) => {
    Keyboard.dismiss();
      ...
      >
        <View style={styles.addrBookFlex}>
          <Pressable
            ...
            onPressIn={() => dismissKeyboardAndRun(onClose)}
          >
          ...
          <View style={styles.centeredView} pointerEvents="box-none">
            ...
            >
              ...
              />
              <TouchableOpacity
                onPress={() => dismissKeyboardAndRun(onSelectPassword)}
                style={[
                  styles.optionButton,
              ...
              <TouchableOpacity
                onPress={() => dismissKeyboardAndRun(onSelectPattern)}
                style={[
                  styles.optionButton,
            ...
            <View style={[containerStyle, modalCenterStyle]}>
              ...
              >
                ...
                <TouchableOpacity
                  ...
                  onPress={() => dismissKeyboardAndRun(onSubmit)}
                >
            ...
            <View style={styles.changeLockModal}>
              ...
              >
                ...
                <TouchableOpacity
                  ...
                  onPress={() =>
                    dismissKeyboardAndRun(() =>
                      onSubmit && onSubmit(resolvedCurrentPassword)
                    )
                  }
                >
