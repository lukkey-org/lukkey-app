...
const TransferConfirmModal = (props) => {
  ...
  useEffect(() => {
    setNftImageLoadFailed(false);
  }, [
    props.selectedNFT?.logoUrl,
    props.selectedNFT?.imageUrl,
    props.selectedNFT?.image,
    props.selectedNFT?.imageURI,
  ]);
  ...
  const CopyLine = ({
    ...
    return (
      ...
      >
        ...
        >
          <Text style={[textStyle, { lineHeight, marginBottom: 0 }]}>
            <Text
        ...
        >
          <Icon
            name="content-copy"
            size={22}
            color={value ? (isDarkMode ? "#ffffff" : "#676776") : "#aaa"}
          />
        </TouchableOpacity>
      </View>
    );
      ...
      >
        <View style={{ flex: 1 }}>
          ...
          <View style={VaultScreenStyle.centeredView} pointerEvents="box-none">
            ...
            <View
              style={[
                VaultScreenStyle.ContactFormModal,
                {
            ...
            >
              ...
              >
                {nftImageUri && !nftImageLoadFailed ? (
                  <Image
                    ...
                    style={{
                      ...
                      marginRight: 14,
                      overflow: "hidden",
                      backgroundColor: isDarkMode ? "#3A3A3E" : "#E6E6EA",
                    }}
                    resizeMode="cover"
                    onError={() => setNftImageLoadFailed(true)}
                  />
                ) : (
                  <View
                    style={{
                      ...
                      borderWidth: 1,
                      borderColor: isDarkMode
                        ? "rgba(204, 182, 140, 0.38)"
                        : "rgba(207, 171, 149, 0.42)",
                      backgroundColor: isDarkMode
                        ? "rgba(204, 182, 140, 0.08)"
                        : "rgba(207, 171, 149, 0.12)",
                    }}
                  >
                    <Text
                      style={{
                        color: isDarkMode ? "#CCB68C" : "#9A6F58",
                        fontSize: 10,
                        fontWeight: "700",
                      }}
                    >
  ...
  const networkDisplay =
    displayChainName(selectedCryptoChain) || displayChainName(detectedNetwork);
