...
const networkImages = {
  ...
  Dogecoin: require("./../assets/icon/DOGEIcon.webp"),
  Ethereum: require("./../assets/icon/ETHIcon.webp"),
  "Ethereum Classic": require("./../assets/icon/ETCIcon.webp"),
  // Fantom: require("./../assets/icon/FTMIcon.webp"), // Fantom Opera migrated to Sonic and is no longer supported.
  "IoTeX Network Mainnet": require("./../assets/icon/IOTXIcon.webp"),
  Litecoin: require("./../assets/icon/LTCIcon.webp"),
  // "OKX Chain": require("./../assets/icon/OKTIcon.webp"), // OKB is no longer supported.
...
const hiddenInDevelopmentNetworks = new Set([
  "Celestia",
  "Gnosis",
  "Juno",
  "Linea",
...
const networks = [
  ...
  "Ethereum",
  "Ethereum Classic",
  // "Fantom", // Fantom Opera migrated to Sonic and is no longer supported.
  "IoTeX Network Mainnet",
  "Litecoin",
  // "OKX Chain", // OKB is no longer supported.
  "Optimism",
  "Polygon",
  "Ripple",
  "Solana",
  ...
  .filter((network) => RUNTIME_DEV || !hiddenInDevelopmentNetworks.has(network))
  .sort();
